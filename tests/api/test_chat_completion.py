...
class TestChatCompletionParameters:
    ...
    def test_chat_completion_temperature(self, api_client, sample_chat_request, temperature):
    ...
    @pytest.mark.api
    def test_chat_completion_max_completion_tokens(self, api_client, sample_chat_request):
