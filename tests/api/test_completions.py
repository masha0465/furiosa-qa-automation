...
class TestCompletionsParameters:
    ...
    def test_completion_max_tokens(self, api_client, sample_completion_request, max_tokens):
    ...
    def test_completion_temperature(self, api_client, sample_completion_request, temperature):
